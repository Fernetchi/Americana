 ...
 * @author Fernando
 */
public class frmBuscarEncuesta2 extends javax.swing.JFrame {
...
//        String titulos[] = {"idRegistro","codigoEn", "nombreEn", "apellidoEn", "edadEn", "sexoEn", "dptoEn", "ciudadEn", "barrioEn"};
    ...
    public frmBuscarEncuesta2() {
        ...
        try {
               ...
               while(rs.next()) {
                   ...
                   fila[6] = rs.getString("ciudadEn");
                   fila[7] = rs.getString("barrioEn");
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Codigo", "Nombre", "Apellido", "Edad", "Sexo", "Ciudad", "Barrio"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmBuscarEncuesta2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new frmBuscarEncuesta2().setVisible(true);
        });
    }
